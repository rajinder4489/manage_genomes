    ...
    run:
        if config["build_indices"]["star"]["run"]:
            ...
            shell(
                ...
                STAR --runMode genomeGenerate --genomeDir {star_indices_path}/{species}/{assembly}_{release}_{seqtype} --sjdbGTFfile {input.gtf_file} --genomeFastaFiles {params.fasta_files} {params.params}
