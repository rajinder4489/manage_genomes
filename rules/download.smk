rule download_annotation:
    output:
        dynamic(os.path.join(annotation_download_path, "{species}", "{assembly}", "{release}", "annotation", "{a_file}"))
...
rule download_genome_ensembl:
    output:
        dynamic(os.path.join(fasta_download_path, "{species}", "{assembly}", "{release}", "{seqtype}", "{g_file}"))
